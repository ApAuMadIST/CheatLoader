...
class GuiSlotStatsBlock extends GuiSlotStats {
	...
	public GuiSlotStatsBlock(GuiStats guiStats1) {
		...
		Iterator iterator2 = StatList.field_25185_d.iterator();
		...
		while(iterator2.hasNext()) {
			...
			if(GuiStats.func_27142_c(guiStats1).writeStat(statCrafting3) > 0) {
				z4 = true;
			} else if(StatList.field_25172_A[i5] != null && GuiStats.func_27142_c(guiStats1).writeStat(StatList.field_25172_A[i5]) > 0) {
				z4 = true;
	...
	protected void func_27260_a(int i1, int i2, Tessellator tessellator3) {
		...
		if(this.field_27268_b == 0) {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 115 - 18 + 1, i2 + 1 + 1, 18, 18);
		} else {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 115 - 18, i2 + 1, 18, 18);
		}

		if(this.field_27268_b == 1) {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 165 - 18 + 1, i2 + 1 + 1, 36, 18);
		} else {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 165 - 18, i2 + 1, 36, 18);
		}

		if(this.field_27268_b == 2) {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 215 - 18 + 1, i2 + 1 + 1, 54, 18);
		} else {
			GuiStats.func_27128_a(this.field_27274_a, i1 + 215 - 18, i2 + 1, 54, 18);
		}
	...
	protected void drawSlot(int i1, int i2, int i3, int i4, Tessellator tessellator5) {
		...
		GuiStats.func_27148_a(this.field_27274_a, i2 + 40, i3, i7);
		this.func_27265_a((StatCrafting)StatList.field_25158_z[i7], i2 + 115, i3, i1 % 2 == 0);
		this.func_27265_a((StatCrafting)StatList.field_25172_A[i7], i2 + 165, i3, i1 % 2 == 0);
